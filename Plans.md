...
| 2.3 | Wire `CredentialPort` impl into qa-core via dependency injection | qa-core receives CredentialPort implementation at startup; answer authority weight computed via port; no hard dependency on identity-verification | Phase 1, 2.2.1, 2.2.4 | cc:done [pending] |
