...
| 2.1.3 | Run conformance test suite against both adapters | Single test suite runs against SQLite and Postgres in parallel; all tests pass on both | 2.1.1, 2.1.2 | cc:done [b18fddf] |
