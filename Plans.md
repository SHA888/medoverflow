...
| 3.1.3 | Create FHIR Zulip adapter — link records only, assert no body copied | Adapter: emits link records (title + URL + metadata); asserts no body copy; all records have License::LinkOnly | 3.1.1 | cc:done [4207081] |
